...
import { deleteCountry, getCountries, reset } from '../features/country/countrySlice';
                                                        ...
                                                        <tr key={index}>
                                                            ...
                                                            <td>
                                                                <i className="fa-regular p-2 m-1 fa-pen-to-square fa-md pointer text-primary border rounded-2"
                                                                    onClick={() => {
                                                                        nav(`/AdvisorDashboard/Country/edit/${country?.countryId}`)
                                                                    }} />
                                                                <i className="fa-regular p-2 m-1 fa-trash fa-md pointer text-danger border rounded-2"
                                                                    onClick={() => {
                                                                        dispatch(deleteCountry(country?.countryId)).then(()=>{
