...
import { login, logout, reset, resetPassword } from '../features/auth/authSlice'
...
const ChangePassword = () => {
    ...
    const handleChange = e => setChangePasswordForm({ ...changePasswordForm, [e.target.name]: e.target.value });
