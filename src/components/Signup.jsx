...
const Signup = () => {
    ...
    const handleCountryChange = (e) => {
        if (e.target.value !== "") {
            ...
            setSignupForm({ ...signupForm, countryCode: "",stateCode: "",cityCode: ""});
        }
    }
    ...
    return (
        <Container fluid>
            <Row>
                <Col md={12} lg={6} className='d-flex align-items-center justify-content-cente'>
                ...
                <Col md={12} lg={6} className="d-flex align-items-center justify-content-center p-5">
                    <Card className='w-100 shadow mt-5 m-auto'>
                        <Card.Body className='mx-5'>
                            <Form onSubmit={handleSubmit} className='p-3 py-2'>
                                ...
                                <h2 className='text-center py-2'>SingUp</h2>
                                ...
                                <Row>
                                    <Col md={6}>
                                        <Form.Group controlId="formBasicCountry" className='p-2 py-3'>
                                            ...
                                            >
                                                ...
                                                {countries?.map(country => (
                                                    <option value={JSON.stringify(country)} key={country.countryCode}>
                                                        {country.countryName}
                                                    </option>
                                                ))}
                                            </Form.Select>
                                    ...
                                    <Col md={6}>
                                        <Form.Group controlId="formBasicState" className='p-2 py-3'>
                                            ...
                                            <Form.Select
                                                ...
                                                required
                                            >
                                                <option value="" default>Select State Code</option>
                                                {states?.map(state => (
                                                    <option value={JSON.stringify(state)} key={state.stateCode}>
                                                        {state.stateName}
                                                    </option>
                                                ))}
                                            </Form.Select>
                                    ...
                                    <Col md={12}>
                                        <Form.Group controlId="formBasicState" className='p-2 py-3'>
                                            ...
                                            <Form.Select
                                                ...
                                                required
                                            >
                                                <option value="" default>Select City Code</option>
                                                {cities?.map(city => (
                                                    <option value={JSON.stringify(city)} key={city.cityCode}>
                                                        {city.cityName}
                                                    </option>
                                                ))}
                                            </Form.Select>
